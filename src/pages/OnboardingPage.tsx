...
export const OnboardingPage = ({ onComplete }: OnboardingPageProps) => {
    ...
    const [dietary, setDietary] = useState<"halal" | "no-preference">(
    "no-preference"
    );
    const [transport, setTransport] = useState<
    "public-transport" | "taxi" | "own-vehicle"
    >("own-vehicle");
    ...
    return (
        ...
        <div className="w-full max-w-md">
            ...
            className="space-y-6 bg-card p-6 rounded-lg border border-border shadow-lg"
            >
            {/* Name */}
            ...
            <div className="space-y-3">
                ...
                value={userType}
                onValueChange={(value) =>
                    setUserType(value as "local" | "tourist")
                }
                >
            ...
            <div className="space-y-3">
                ...
                value={dietary}
                onValueChange={(value) =>
                    setDietary(value as "halal" | "no-preference")
                }
                >
                <div className="flex items-center space-x-2 p-3 rounded-md border border-border hover:bg-accent/50 transition-colors">
            ...
            <div className="space-y-3">
                ...
                onValueChange={(value) =>
                    setTransport(
                    value as "public-transport" | "taxi" | "own-vehicle"
                    )
                }
                >
                <div className="flex items-center space-x-2 p-3 rounded-md border border-border hover:bg-accent/50 transition-colors">
